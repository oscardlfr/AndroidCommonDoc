...
15 domain hubs, 57 sub-docs, 16 guides, 6 agent workflow docs -- all with YAML frontmatter for registry scanning, upstream monitoring, and Detekt rule generation.
...
+-- docs/                   # 15 hub docs, 57 sub-docs, 16 guides, 6 agent workflow docs
