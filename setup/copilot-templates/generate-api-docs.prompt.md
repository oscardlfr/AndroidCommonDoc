<!-- GENERATED from skills/generate-api-docs/SKILL.md -- DO NOT EDIT MANUALLY -->
...
Optional: Run Dokka + transformer to generate docs/api/ from KDoc in source code. Produces YAML-frontmatter docs consumable by context-provider and search-docs.
