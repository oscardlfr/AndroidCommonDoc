...
- DON'T: BAD: Hardcoded route strings are error-prone and not type-safe
- DO: Type-safe navigation with compile-time argument validation
- DON'T: BAD: Channel buffers events -- stale navigation fires after config changes
...
- DON'T: BAD: Running intensive tasks regardless of focus wastes CPU
- DON'T: BAD: GlobalScope tasks are never cancelled -- memory leaks
