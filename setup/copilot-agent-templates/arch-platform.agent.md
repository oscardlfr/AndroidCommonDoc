<!-- GENERATED from .claude/agents/arch-platform.md -- DO NOT EDIT MANUALLY -->
...
tools: [read, run_terminal_command, SendMessage, mcp__androidcommondoc__dependency-graph, mcp__androidcommondoc__gradle-config-lint, mcp__androidcommondoc__kdoc-coverage, mcp__androidcommondoc__string-completeness, mcp__androidcommondoc__verify-kmp-packages]
---
