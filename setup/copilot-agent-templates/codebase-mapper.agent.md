<!-- GENERATED from .claude/agents/codebase-mapper.md -- DO NOT EDIT MANUALLY -->
...
tools: [read, search, run_terminal_command, edit, mcp__androidcommondoc__dependency-graph, mcp__androidcommondoc__module-health, mcp__androidcommondoc__pattern-coverage, mcp__androidcommondoc__code-metrics, mcp__androidcommondoc__find-pattern]
---

## Available Skills (invoke via slash commands)

- **/map-codebase**: Structured codebase analysis using the `codebase-mapper` agent.
