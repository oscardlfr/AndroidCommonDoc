<!-- GENERATED from .claude/agents/ui-specialist.md -- DO NOT EDIT MANUALLY -->
...
tools: [read, edit, Edit, run_terminal_command, SendMessage, mcp__androidcommondoc__compose-preview-audit, mcp__androidcommondoc__string-completeness]
---

## Available Skills (invoke via slash commands)

- **/accessibility**: Audit web accessibility against WCAG 2.1. Use when asked about a11y, WCAG compliance, or screen reader support.
- **/lint-resources**: Validate string resource naming conventions (snake_case, prefixes, duplicates, Swift sync). Use when checking resource files or before merging UI changes.
