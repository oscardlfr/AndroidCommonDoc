<!-- GENERATED from .claude/agents/debugger.md -- DO NOT EDIT MANUALLY -->
...
tools: [read, edit, Edit, run_terminal_command, search, WebSearch]
---
...
- **/debug**: Systematic bug investigation using the `debugger` agent.
