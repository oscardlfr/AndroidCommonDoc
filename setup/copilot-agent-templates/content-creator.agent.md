<!-- GENERATED from .claude/agents/content-creator.md -- DO NOT EDIT MANUALLY -->
...
tools: [read, search, WebSearch, SendMessage]
---
...
**Per-session gate**: Before your FIRST WebSearch call in any session, you MUST have received a SendMessage response from context-provider in this session. Context-provider has cached product state — check there before searching externally.
...
|----------------|------------|
| Development (team-lead) | Content calendar, upcoming deadlines, what technical info needed |
| Business (product-strategist) | Engagement signals, market feedback from posts |

### Imports
| Source dept | You need | When |
|-----------|---------|------|
| Development (team-lead) | What was built, technical details, code snippets, metrics | For release notes, blog posts |
