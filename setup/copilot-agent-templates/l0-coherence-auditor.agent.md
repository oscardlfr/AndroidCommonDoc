<!-- GENERATED from .claude/agents/l0-coherence-auditor.md -- DO NOT EDIT MANUALLY -->
...
tools: [read, search, mcp__androidcommondoc__validate-claude-md, mcp__androidcommondoc__validate-doc-structure, mcp__androidcommondoc__validate-skills, mcp__androidcommondoc__validate-vault, mcp__androidcommondoc__validate-agents, mcp__androidcommondoc__validate-all, mcp__androidcommondoc__audit-docs]
---

## Available Skills (invoke via slash commands)

- **/audit-l0**: Run coherence audit on any L0/L1/L2 layer root. Checks hub doc presence, line limits, frontmatter completeness, .planning/ references, monitor_urls coverage, and detekt_rules coverage. Use when validating ecosystem-wide doc health.
