<!-- GENERATED from .claude/agents/release-guardian-agent.md -- DO NOT EDIT MANUALLY -->
...
tools: [read, search, mcp__androidcommondoc__scan-secrets, mcp__androidcommondoc__proguard-validator, mcp__androidcommondoc__check-version-sync]
---

## Available Skills (invoke via slash commands)

- **/sbom**: Generate CycloneDX SBOM for project modules. Use when asked to produce a software bill of materials.
