<!-- GENERATED from .claude/agents/arch-integration.md -- DO NOT EDIT MANUALLY -->
...
tools: [read, run_terminal_command, SendMessage, mcp__androidcommondoc__dependency-graph, mcp__androidcommondoc__gradle-config-lint, mcp__androidcommondoc__setup-check]
---
