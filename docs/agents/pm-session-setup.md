...
targets: [all]
slug: pm-session-setup
status: active
layer: L0
parent: agents-hub
category: agents
description: "PM session setup: Phase 2 core dev spawning, selective spawning, rotation protocol, context management, architect routing."
version: 1
last_updated: "2026-04"
assumes_read: team-topology, pm-phase-execution
token_budget: 1500
---

# PM Session Setup

Reference for PM's session initialization: Phase 2 core dev spawning, selective spawning rules, long-session rotation, context management, architect routing, and correct TeamCreate patterns.
