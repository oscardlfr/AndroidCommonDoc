---
scope: [agents, team-lead, orchestration]
...
layer: L0
category: agents
description: "team-lead protocols hub: session setup, phase execution, dispatch topology, verification gates, model profiles, git workflow, agent roster"
version: 1
...
Team-lead orchestrator protocols extracted from agents-hub (BL-W47-prep-6 fixup).
