...
| [testing-compose-ui-test-v2](testing-compose-ui-test-v2.md) | **L2 (DawSync/WakeTheCave): migrate `runComposeUiTest` to `.v2` package (L1 NO-OP).** CMP 1.11 package change, StandardTestDispatcher default, advanceUntilIdle() |
