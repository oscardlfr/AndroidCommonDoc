...
# CLI Mandate — kmp-test-runner (v0.10.1+)
...
`jsTest`, `jsBrowserTest`, `jsNodeTest`, `wasmJsTest` are blocked by the gate with a special message: _"kmp-test-runner v0.10.1 CLI does not yet fully support JS/Wasm targets — track https://github.com/oscardlfr/kmp-test-runner/releases for v0.11+ support."_ Do not invoke these directly.
