...
| [copilot-templates-regen](copilot-templates-regen.md) | How to regenerate GitHub Copilot prompt templates via `copilot-adapter.sh` after skill changes; includes VS Code LSP channel roadmap (Alpha) |
