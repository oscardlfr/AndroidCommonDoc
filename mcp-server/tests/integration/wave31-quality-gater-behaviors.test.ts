 ...
 *    - Have template_version "2.11.0" (bumped from BL-W31.7-10 baseline "2.6.0")
...
describe("quality-gater template enforces T-BUG-015 Search Dispatch Protocol", () => {
  ...
  it('template_version is "2.11.0" (higher than BL-W31.7-10 baseline "2.6.0")', () => {
    expect(setupFrontmatter).not.toBeNull();
    expect(setupFrontmatter?.template_version).toBe("2.11.0");
  });
