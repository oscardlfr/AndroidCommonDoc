...
describe('doc-updater template', () => {
  ...
  it('template version bumped to 2.10.0', () => {
    expect(content).toContain('template_version: "2.10.0"');
  });
});
...
describe('quality-gater template', () => {
  ...
  it('template version 2.14.0', () => {
    expect(content).toContain('template_version: "2.14.0"');
  });
