...
describe('arch-testing template — Bash safety and version', () => {
  ...
  it('template version 1.26.0', () => {
    expect(archContent).toContain('template_version: "1.26.0"');
  });
...
describe('arch-platform + arch-integration — caller grep rule', () => {
  ...
  it('arch-platform has template version 1.24.0', () => {
    expect(platformContent).toContain('template_version: "1.24.0"');
  });

  it('arch-integration has template version 1.23.0', () => {
    expect(integrationContent).toContain('template_version: "1.23.0"');
  });
});
...
describe('architect templates — PRE-TASK protocol', () => {
  ...
  it('arch-testing version 1.26.0', () => {
    expect(testingContent).toContain('template_version: "1.26.0"');
  });
});
