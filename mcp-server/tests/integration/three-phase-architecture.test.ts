...
describe('project-manager template — 3-phase model', () => {
  ...
  it('template version 5.11.0', () => {
    expect(content).toContain('template_version: "5.11.0"');
  });
...
describe('arch-testing template — Bash safety and version', () => {
  ...
  it('template version 1.15.0', () => {
    expect(archContent).toContain('template_version: "1.15.0"');
  });
...
describe('arch-platform + arch-integration — caller grep rule', () => {
  ...
  it('arch-platform has template version 1.12.0', () => {
    expect(platformContent).toContain('template_version: "1.12.0"');
  });

  it('arch-integration has template version 1.12.0', () => {
    expect(integrationContent).toContain('template_version: "1.12.0"');
  });
});
...
describe('architect templates — PRE-TASK protocol', () => {
  ...
  it('arch-testing version 1.15.0', () => {
    expect(testingContent).toContain('template_version: "1.15.0"');
  });
});
