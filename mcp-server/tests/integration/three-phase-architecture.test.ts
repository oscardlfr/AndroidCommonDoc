...
describe('arch-testing template — Bash safety and version', () => {
  ...
  it('template version 1.22.0', () => {
    expect(archContent).toContain('template_version: "1.22.0"');
  });
...
describe('arch-platform + arch-integration — caller grep rule', () => {
  ...
  it('arch-platform has template version 1.20.0', () => {
    expect(platformContent).toContain('template_version: "1.20.0"');
  });

  it('arch-integration has template version 1.19.0', () => {
    expect(integrationContent).toContain('template_version: "1.19.0"');
  });
});
...
describe('quality-gater template — gate protocol', () => {
  ...
  it('has template version 2.7.0', () => {
    expect(content).toContain('template_version: "2.7.0"');
  });
});
...
describe('architect templates — PRE-TASK protocol', () => {
  ...
  it('arch-testing version 1.22.0', () => {
    expect(testingContent).toContain('template_version: "1.22.0"');
  });
});
