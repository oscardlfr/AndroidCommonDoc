...
describe('Wave 1: template_version bumped in architects', () => {
  it('arch-testing.md template_version is "1.25.0"', () => {
    // BL-W35-03: bumped from 1.24.0 → 1.25.0 (post-compaction re-sync protocol)
  ...
  it('arch-platform.md template_version is "1.23.0"', () => {
    // BL-W35-03: bumped from 1.22.0 → 1.23.0 (post-compaction re-sync protocol)
  ...
  it('arch-integration.md template_version is "1.22.0"', () => {
    // BL-W35-03: bumped from 1.21.0 → 1.22.0 (post-compaction re-sync protocol)
