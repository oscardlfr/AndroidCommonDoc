...
describe('Wave 1: template_version bumped in architects', () => {
  it('arch-testing.md template_version is "1.41.0"', () => {
    ...
    // Wave 1 WP5: bumped from 1.39.0 → 1.40.0 (runtime-messaging-adapters pointer)
    // Structured verdict contract: bumped from 1.40.0 → 1.41.0.
    const content = fs.readFileSync(path.join(TEMPLATES_DIR, 'arch-testing.md'), 'utf-8');
    expect(content).toMatch(/template_version:\s*"1.41.0"/);
  });

  it('arch-platform.md template_version is "1.36.0"', () => {
    ...
    // Wave 1 WP5: bumped from 1.34.0 → 1.35.0 (runtime-messaging-adapters pointer)
    // Structured verdict contract: bumped from 1.35.0 → 1.36.0.
  ...
  it('arch-integration.md template_version is "1.32.0"', () => {
    ...
    // Wave 1 WP5: bumped from 1.30.0 → 1.31.0 (runtime-messaging-adapters pointer)
    // Structured verdict contract: bumped from 1.31.0 → 1.32.0.
