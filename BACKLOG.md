...
- **bl-w47-pr-0c2** (2026-06-14) — QG-proof push gate: canonical emit-push-proof.sh runner + verdict→HEAD binding + bypass audit trail + 24-test bats suite; portable-core with PS1 parity. — `project_wave_bl_w47_pr_0c2_shipped.md`
