...
> **Last updated**: 2026-07-07; Harness Realignment Wave 0 (Harness State Ledger Reconciliation, #234 `0bbf6fa`) and Wave 1 (Runtime/Topology Contract Realignment, #235 `125409b`) are both MERGED to develop; **Wave 2 — Portable Coordination Artifact Layer is the active wave**; RTK template sweep remains deferred pending separate approval
...
- **Wave 2 — Portable Coordination Artifact Layer** (HARNESS — **ACTIVE WAVE**) — implement the ADR-001 disk-inbox fallback so non-Claude runtimes can coordinate without SendMessage.
...
**Sequencing**: Waves 0 and 1 are MERGED; **Wave 2 — Portable Coordination Artifact Layer is the current active wave**. After Wave 2, Wave 3 (Phase-Orchestration Restoration) is next. Recommended minimum Waves 0-5; Wave 6 is optional hardening after Wave 5.
