...
const INBOUND_ROOTS = [
  ...
  { name: 'ThreadReadResponse', ns: 'v2', file: 'v2/ThreadReadResponse.json' },
...
const OUTBOUND_ROOTS = [
  ...
  { name: 'ThreadReadParams', ns: 'v2', file: 'v2/ThreadReadParams.json', producedBy: 'threadRead() hydration request' },
