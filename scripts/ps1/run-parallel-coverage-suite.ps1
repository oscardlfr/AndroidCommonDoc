...
<#
.SYNOPSIS
    Thin wrapper around kmp-test-runner v0.8.1 (BL-W32-06e).
...
if ($FreshDaemon) {
    Write-Warning "WARNING: -FreshDaemon not supported by kmp-test-runner v0.8.1; flag ignored. See GAP-01."
}
