...
<#
.SYNOPSIS
    Thin wrapper around kmp-test-runner v0.7.0 (BL-W32-06e).
...
if ($FreshDaemon) {
    Write-Warning "WARNING: -FreshDaemon not supported by kmp-test-runner v0.7.0; flag ignored. See GAP-01."
}
