#!/usr/bin/env bash
# BL-W32-06e: Thin wrapper around kmp-test-runner v0.9.0.
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --fresh-daemon)
      echo "WARNING: --fresh-daemon not supported by kmp-test-runner v0.9.0; flag ignored. See GAP-01." >&2
      shift ;;
    --exclude-coverage)
    ...
    -h|--help)
      ...
      echo ""
      echo "Thin wrapper around kmp-test-runner v0.9.0."
      echo ""
      echo "Options:"
